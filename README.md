...
## 📅 Day 19: Large Language Models (LLMs) & API Integration with Groq
...
### 🛠️ 3. Creating the Client & Making Queries
Using the `groq` library in Python, we initialize the client with our API key and request responses from an LLM.

#### 📝 Client Initialization ([main.ipynb](file:///c:/Users/vijay/Desktop/pythonCourse/week_04/main.ipynb#L1-L34))
```python
...
#### 💬 Query-Answer System ([main.ipynb](file:///c:/Users/vijay/Desktop/pythonCourse/week_04/main.ipynb#L50-L63))
```python
# Get user prompt
